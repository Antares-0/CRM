...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //添加评论，自己的部分
            $("#saveNewRemarkBtn").click(function () {
                var noteContent = $("#remark").val();
                var clueId = '${clue.id}';
                $.ajax({
                    url: 'workbench/clue/insertNewClueRemark.do',
                    data: {
                    ...
                    success: function (data) {
                        if (data.code == "1") {
                            // 做一个刷新，或者可以用拼接字符串的形式实现
                            window.location.href = 'workbench/clue/queryClueForDetail.do?id=' + '${clue.id}';
                        } else {
                            alert(data.message);
                        }
                    }
    ...
    <div id="remarkDiv" style="background-color: #E6E6E6; width: 870px; height: 90px;">
        <form role="form" style="position: relative;top: 10px; left: 10px;">
            ...
            <p id="cancelAndSaveBtn" style="position: relative;left: 737px; top: 10px; display: none;">
                ...
                <button type="button" class="btn btn-primary" id="saveNewRemarkBtn">保存</button>
            </p>
        </form>
    </div>
</div>
